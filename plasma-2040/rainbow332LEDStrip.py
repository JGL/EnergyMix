...
# via https://github.com/pimoroni/pimoroni-pico/blob/main/micropython/examples/plasma2040/rainbow.py
...
# important to see the v/brightness to 0.5 when using 332 pixels, as otherwise more than 1.5A is drawn, shutting down the board
